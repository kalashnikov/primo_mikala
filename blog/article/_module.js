...
function create_fragment$5(ctx) {
	...
	let if_block;
	let current;
	const if_block_creators = [create_if_block$4, create_if_block_2$1, create_if_block_3$1];
	const if_blocks = [];
